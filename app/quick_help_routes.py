...
QUICK_HELP_ROUTES: dict[str, QuickHelpRoute] = {
    ...
    for route in (
        ...
        QuickHelpRoute(
            prompt="Can I buy a physical textbook after opting out?",
            source_paths=("data/faqs/ia_opt_out_physical_textbooks.txt",),
            answer_kind="faq",
            source="QUICK_HELP:ia_opt_out_physical_textbooks.txt",
        ),
        QuickHelpRoute(
        ...
        QuickHelpRoute(
            prompt="How do I opt out in Canvas?",
            source_paths=("data/faqs/immediate_access/ia_opt_out_canvas.txt",),
            answer_kind="faq",
            source="QUICK_HELP:immediate_access/ia_opt_out_canvas.txt",
        ),
        QuickHelpRoute(
            prompt="Can I opt out of Immediate Access?",
            source_paths=("data/faqs/immediate_access/ia_opt_out_canvas.txt",),
            answer_kind="faq",
            source="QUICK_HELP:immediate_access/ia_opt_out_canvas.txt",
        ),
        QuickHelpRoute(
            prompt="Can I opt out in Canvas?",
            source_paths=("data/faqs/immediate_access/ia_opt_out_canvas.txt",),
            answer_kind="faq",
            source="QUICK_HELP:immediate_access/ia_opt_out_canvas.txt",
        ),
        ...
        QuickHelpRoute(
            prompt="Where do I opt out of Immediate Access?",
            source_paths=("data/faqs/immediate_access/ia_opt_out_canvas.txt",),
            answer_kind="faq",
            source="QUICK_HELP:immediate_access/ia_opt_out_canvas.txt",
        ),
